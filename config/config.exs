...
config :lights_out, LightsOutWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: LightsOutWeb.ErrorHTML, json: LightsOutWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: LightsOut.PubSub,
  live_view: [signing_salt: "Uz0roGIF"]
...
config :lights_out, LightsOut.Mailer, adapter: Swoosh.Adapters.Local
